...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament temp : apartaments)
        {
            if (temp instanceof Apt1Room) ((Apt1Room) temp).clean1Room();
            if (temp instanceof Apt2Room) ((Apt2Room) temp).clean2Rooms();
            if (temp instanceof Apt3Room) ((Apt3Room) temp).clean3Rooms();
        }
