...
public class Solution
{
    ...
    public static void readKeyFromConsoleAndInitPlanet()
    {
        ...
        try
        {
            ...
            if (input.equals(Planet.EARTH))thePlanet = Earth.getInstance();
            else if (input.equals(Planet.MOON)) thePlanet = Moon.getInstance();
            else if (input.equals(Planet.SUN)) thePlanet = Sun.getInstance();
            else thePlanet = null;
        }
        catch (IOException e)
        {
