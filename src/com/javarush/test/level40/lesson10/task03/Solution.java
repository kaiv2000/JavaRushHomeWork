...
public class Solution {
    ...
    public static String weekDayOfBirthday(String birthday, String year) {
        ...
        String dayForFound = birthday.substring(0, 6) + year;

        DateTimeFormatter formatter = DateTimeFormat.forPattern("dd.MM.yyyy");
        DateTime dateTime = formatter.parseDateTime(dayForFound);

        DateTimeFormatter formatterNew = DateTimeFormat.forPattern("EEEE");

        return formatterNew.withLocale(Locale.ITALIAN).print(dateTime);
    }
}